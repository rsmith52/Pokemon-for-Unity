...
namespace Pokemon
{
    public class Ribbons
    {
        ...
        public static readonly string[] RIBBON_DESCRIPTIONS = new string[]
        {
            ...
            "Ribbon for clearing the PokÈmon League and entering the Hall of Fame in another region. ",
            ...
            "PokÈmon Event Participation Ribbon.",
            ...
            "A Ribbon awarded to a PokÈmon deemed to have a top-quality footprint.",
            ...
            "A Ribbon that proclaims love for PokÈmon.",
            ...
            "PokÈmon League Champion Ribbon.",
            "Battle Competition Champion Ribbon.",
            "PokÈmon World Championships Regional Champion Ribbon.",
            "A Ribbon awarded for winning 100 matches in a row.",
            "PokÈmon League Champion Ribbon.",
            "PokÈmon World Championships National Champion Ribbon.",
            "PokÈmon World Championships World Champion Ribbon."
        };
